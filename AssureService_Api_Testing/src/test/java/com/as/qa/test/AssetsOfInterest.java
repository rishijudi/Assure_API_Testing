...
public class AssetsOfInterest extends BaseSetup {
	...
	@Test(priority = 1)//Not Yet Ready
	public void testGetAssureAssetChildCountByPrimaryClassification() throws IOException {
		String baseUrl = loadProperties().getProperty("BaseURIH");
        String assurePath = loadProperties().getProperty("assurePath");
        String classId = loadProperties().getProperty("ClassId");
        String nsfilter = loadProperties().getProperty("nsfilter");
        // Set the endpoint and query parameters
        String endPointUrl = "/asset_count";
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("primaryClassificationId", classId);
        queryParams.put("nsfilter", nsfilter);
        String endpoint = baseUrl + assurePath + endPointUrl;
        ...
        System.out.println("=========="+asPrettyString);
        Assert.assertEquals(statusCode, 200, "Expected status code 200");
        response.then().assertThat().body(matchesJsonSchemaInClasspath("AssetsOfInterest_Json\\Get_body\\asset_count.json"));
        long responseTime = response.time();
        System.out.println("Response time: " + responseTime + " ms");
        Assert.assertTrue(responseTime < 2000, "Response time is too slow");
}
	@Test(priority = 1,enabled = false)//Not Yet Ready
	public void testGetAssureAssetsByAssetCodesAndPrimaryClassification() throws IOException {
		 String baseUrl = loadProperties().getProperty("BaseURIH");
	        String assurePath = loadProperties().getProperty("assurePath");
	        String nsfilter = loadProperties().getProperty("nsfilter");
	        String endPointUrl = "/assetCodesWithEquivalency";
	...
	@Test(priority = 1,enabled = false)//Not Yet Ready
	public void testGetAssureAssetsByQuery() throws IOException {
		 String baseUrl = loadProperties().getProperty("BaseURIH");
	        String assurePath = loadProperties().getProperty("assurePath");
	        String nsfilter = loadProperties().getProperty("nsfilter");
	        String endPointUrl = "/assetCodesWithEquivalency";
	...
	@Test(priority = 1,enabled = false)//Not Yet Ready
	public void testGetAssureAssetCountByPrimaryClassification() throws IOException {
		 String baseUrl = loadProperties().getProperty("BaseURIH");
	        String assurePath = loadProperties().getProperty("assurePath");
	        String nsfilter = loadProperties().getProperty("nsfilter");
	        String endPointUrl = "/assetCodesWithEquivalency";
	...
	@Test(priority = 1,enabled = false)//Not Yet Ready
	public void testUpdateAnAsset() throws IOException {
		 String baseUrl = loadProperties().getProperty("BaseURIH");
	        String assurePath = loadProperties().getProperty("assurePath");
	        String nsfilter = loadProperties().getProperty("nsfilter");
	        String endPointUrl = "/assetCodesWithEquivalency";
	...
	@Test(priority = 1,enabled = false)//Not Yet Ready
	public void testUpdateAsset() throws IOException {
		 String baseUrl = loadProperties().getProperty("BaseURIH");
	        String assurePath = loadProperties().getProperty("assurePath");
	        String nsfilter = loadProperties().getProperty("nsfilter");
	        String endPointUrl = "/assetCodesWithEquivalency";
